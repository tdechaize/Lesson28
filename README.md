# Lesson28
Lesson28 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-dessous les explications vous permettant de regénérer cette application illustrant un cas d'usage d'OpenGL : 
les courbes de Bézier (issu du site NeHe).
